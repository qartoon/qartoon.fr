...
![Text message](/assets/writeups/une-aiguille-dans-une-ile-de-france/text-message.jpg)
...
![Overpass turbo results](/assets/writeups/une-aiguille-dans-une-ile-de-france/results.png)
...
![Best location](/assets/writeups/une-aiguille-dans-une-ile-de-france/best-location.png)
...
![Google search](/assets/writeups/une-aiguille-dans-une-ile-de-france/search.png)

On page 11 of this journal, I found the following article :
![Article](/assets/writeups/une-aiguille-dans-une-ile-de-france/article.png)
