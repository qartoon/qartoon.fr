...
![Discord profile](/assets/writeups/monsieur-c/discord-profile.jpg)
...
![Short screenshot](/assets/writeups/monsieur-c/short-screenshot.png)
...
![Camera display](/assets/writeups/monsieur-c/camera-display.png)
...
![Flowers](/assets/writeups/monsieur-c/flowers.png)
...
![WhatsApp profile](/assets/writeups/monsieur-c/whatsapp-profile.jpg)

A reverse image search of the profile picture then leads to [Camille Guérin]([Camille Guérin — Wikipédia](https://fr.wikipedia.org/wiki/Camille_Gu%C3%A9rin)).
### 🚩 Flag
```
